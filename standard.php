...
$conn= mysqli_connect('localhost','root','','hotelreservation');
                $query="SELECT `standardsingleprice`, `standarddoubleprice`, `standardtripleprice` FROM `admin` WHERE 1";
                $result=mysqli_query($conn,$query);
                $row= mysqli_fetch_assoc($result);

                $standardsingleprice=$row['standardsingleprice'];
                $standarddoubleprice=$row['standarddoubleprice'];
                $standardtripleprice=$row['standardtripleprice'];
 ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <center>
    <h5>This impressive guest accommodation offers you the epitome of personalized service, and the <br>fully furnished open air terrace is perfectly situated to provide breathtakingly beautiful…</h5>
  </center>
  <br>
  <div class="container" style="background-color: #FFFACD;">
    ...
    <div class="row">
      <div class="col-sm-4" id="bor">
        <img src="\project2\img\q10.jpg" class="a-block img-fluid ">
        <br>
        <center>
          <h3>Single Room</h3>
          <h2>Rs: <?php echo $standardsingleprice; ?></h2>
          <br>
        </center>
        <form action="reservationS.php" method="post" class="form-horizantal">
          Total Room: <?php echo $remainingsinglest; ?>
          <!-- <div class="form-group">
            <label>Insert room for booking</label>
            <input type="number" class="form-control" min="0" max="<?php echo $remainingsinglest; ?>" name="singleroom" placeholder="no of room" value="0" required="true" style="width: 60%">
          </div> -->
      </div>
      <div class="col-sm-4" id="bor">

        <img src="\project2\img\rr2.jpg" class="a-block img-fluid ">
        <br>
        <center>
          <h3>Double Room</h3>
          <h2>Rs: <?php echo $standarddoubleprice; ?></h2>
          <br>
        </center>
        Total Room: <?php echo $remainingdoublest; ?>
        <!-- <div class="form-group">
          <label>Insert room for booking</label>
          <input type="number" class="form-control" min="0" max="<?php echo $remainingdoublest; ?>" name="doubleroom" placeholder="no of room" value="0" required="true" style="width: 60%">
        </div> -->
      </div>
      <div class="col-sm-4" id="bor">
        <img src="\project2\img\rr6.jpg" class="a-block img-fluid ">
        <br>
        <center>
          <h3>Triple Room</h3>
          <h2>Rs: <?php echo $standardtripleprice; ?></h2>
          <br>
        </center>
        Total Room: <?php echo $remainingtriplest; ?>
        <!-- <div class="form-group">
          <label>Insert room for booking</label>

          <input type="number" class="form-control" min="0" max="<?php echo $remainingtriplest; ?>" name="tripleroom" placeholder="no of room" value="0" required="true" style="width: 60%">
        </div> -->
  ...
  <div class="container">
    <div row align="center">
      <div class="col-sm-10">
        ...
        <a href="reservationS.php?key=standard">
          <input type="button" name="bookS" value="BOOK NOW" class="bn">
        </a>
        </form>
      </div>
    </div>
  ...
  <div class="container-fluid" style="background-color: #E6E6FA ;">
    ...
    <div row align="center">
      <div class="col-sm-12">
        <a class="nav-link footer-links" href="/project2/FProject.html"><img src="\project2\img\logo.png" width="80px" height="80px"></a>
      </div>
    </div>

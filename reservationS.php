      ...
      <div class="navbar-nav ml-auto" style="margin-top:23px;">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <a href="reservationS.php?logout='1'">Logout</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-sm-4" id="form">
        <form method="post" action="reservationS.php">
          ...
          <label style="font-weight: bolder; color: white">Single</label>
              <input type="number" id="single" class="form-control" min="0" max="<?php echo $remainingsinglest; ?>" name="singleroom"  placeholder="no of room" value="0" required="true" style="width: 98%">
              </div>
              <div class="form-group">
          <label style="font-weight: bolder; color: white">Double</label>
              <input type="number" id="double" class="form-control" min="0" max="<?php echo $remainingsinglest; ?>" name="doubleroom" placeholder="no of room" value="0" required="true" style="width: 98%">
              </div>
              <div class="form-group">
          <label style="font-weight: bolder; color: white">Triple</label>
              <input type="number" id="triple" class="form-control" min="0" max="<?php echo $remainingsinglest; ?>" name="tripleroom" placeholder="no of room" value="0" required="true" style="width: 98%">
              </div>
              </div> 
          <div class="form-group">
            <label style="font-weight: bolder; color: white">Check_In</label>
            <input type="date" id="checkindate" class="form-control" name="checkin"  min="<?php echo date("Y-m-d") ; ?>" placeholder="date" required="true" style="border-radius: 7px;">
          </div>
           <div class="form-group">
      ...
      <div class="col-sm-4" id="form">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
          <input type="button" name="reserveS" class="bn3" value="Submit" onclick="getInputValue();" data-toggle="modal" data-target="#exampleModalScrollable">
          <br>
          <br>
          <a href="\project2\index.html">
            <input type="button" class="bn3" value="Back">
          </a>
          </div>
        <!-- Modal -->
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" onload="getInputValue();">
                ...
                function getInputValue(){
                 ...
                 var classicsingle=<?php echo $standardsingleprice; ?>;
                 var classicdouble=<?php echo $standarddoubleprice; ?>;
                 var classictriple=<?php echo $standardtripleprice; ?>;
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name="reserveS" class="btn btn-primary">Confirm Booking</button>
              </div>
            </div>
          </div>
        </div>

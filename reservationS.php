      ...
      <div class="col-sm-4" id="form">
        <form method="post" action="reservationS.php">
          ...
          <div class="form-group">
            Check_In<input type="date" id="checkindate" class="form-control" name="checkin"  min="<?php echo date("Y-m-d") ; ?>" placeholder="date" required="true" style="border-radius: 7px;">
          </div>
           <div class="form-group">
      ...
      <div class="col-sm-4" id="form">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <a href="\project2\index.html"><input type="button" class="bn3" value="Back"></a>
